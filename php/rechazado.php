	...
	<div class="container">
		<div class="row" style="margin-top: 21px;">
			<div class="col-md-6">
				...
				<div style="border-top:none;" class="pagdes">
					<span class="titdescint">fecha l&iacute;mite de pago: </span> <span class="descint">2018-07-28 23:59:59</span>
				</div>
				<div></div>
				<div class="titcopint">
					<span class="tittot">Total a pagar</span>					
					<div>
			...
			<div style="margin-top: 13px;" class="col-md-6">
				...
				<div style="border-top:none;" class="pagdesint">
					<span class="titinfint">Correo electr&oacute;nico: </span> <span class="descintinfo"><?php echo $email ?></span>
				</div>
